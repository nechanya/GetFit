...
for user in users:
    c.execute("INSERT INTO info_about_users"
              "(id, login, password, first_name, last_name, sex, city, weight_now, desired_weight, height, age)"
              "VALUES "
              "('{id}', '{login}', '{password}', '{first_name}', '{last_name}', '{sex}', '{city}', '{weight_now}', '{desired_weight}', '{height}', '{age}')".format(**user))
